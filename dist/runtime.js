...
var BaseAPI = /** @class */ (function () {
    function BaseAPI(configuration) {
        ...
        this.fetchApi = function (url, init) { return __awaiter(_this, void 0, void 0, function () {
            var fetchParams, _i, _a, middleware;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        fetchParams = (_b.sent()) || fetchParams;
                        _b.label = 3;
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
    ...
    BaseAPI.prototype.request = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, url, init, response, errorResponse, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.createFetchParams(context)];
                    case 1:
                    ...
                    case 6:
                        errorResponse = _b.sent();
                        return [3 /*break*/, 7];
                    case 7: throw new XenditSdkError(errorResponse, response.status, response.statusText);
                }
            });
        });
    };
    BaseAPI.prototype.createFetchParams = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var url, headers, initParams, overriddenInit, init;
            return __generator(this, function (_a) {
                ...
                overriddenInit = __assign({}, initParams);
...
var XenditSdkError = /** @class */ (function (_super) {
    __extends(XenditSdkError, _super);
    function XenditSdkError(response, status, statusText) {
        var _this = this;
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        _this = _super.call(this, "[Xendit SDK Error] ".concat(status, " ").concat(statusText)) || this;
        _this.response = response;
        _this.name = "XenditSdkError";
        _this.rawResponse = response;
        _this.status = status || ((_a = _this.rawResponse) === null || _a === void 0 ? void 0 : _a.status) || ((_b = _this.rawResponse) === null || _b === void 0 ? void 0 : _b.status_code) || ((_c = _this.rawResponse) === null || _c === void 0 ? void 0 : _c.statusCode);
        _this.errorCode = ((_d = _this.rawResponse) === null || _d === void 0 ? void 0 : _d.error) || ((_e = _this.rawResponse) === null || _e === void 0 ? void 0 : _e.error_code) || ((_f = _this.rawResponse) === null || _f === void 0 ? void 0 : _f.errorCode);
        _this.errorMessage = ((_g = _this.rawResponse) === null || _g === void 0 ? void 0 : _g.message) || ((_h = _this.rawResponse) === null || _h === void 0 ? void 0 : _h.error_message) || ((_j = _this.rawResponse) === null || _j === void 0 ? void 0 : _j.errorMessage) || statusText;
        return _this;
    }
